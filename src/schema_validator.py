...
class ExtensibleSchemaValidator:
    ...
    def __init__(self, base_schema_path: Union[str, Path], college_config_path: Union[str, Path] = None):
        ...
        self.college_config = self._load_json(college_config_path) if college_config_path else None
    ...
    def _check_textbook_cost(self, data: dict[str, Any]) -> list[str]:
        ...
        errors = []
        valid_categories = {cat['code'] for cat in 
                          self.college_config['features']['textbook_cost']['categories']}
    ...
    def _check_enrollment_tracking(self, data: dict[str, Any]) -> list[str]:
        ...
        errors = []
        required_fields = self.college_config['features']['enrollment_tracking'].get('fields', [])
...
def merge_with_base_schema(
    ...
    college_extensions: dict[str, Any]
) -> dict[str, Any]:
