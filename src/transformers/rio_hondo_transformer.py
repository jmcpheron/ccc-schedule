...
class RioHondoTransformer(BaseTransformer):
    ...
    def _transform_section(self, section_data: dict[str, Any], course_data: dict[str, Any] = None) -> dict[str, Any]:
        ...
        section = {
            ...
            "instruction_mode": self._map_instruction_mode(section_data.get("delivery_method", "")),
            "enrollment": {
    ...
    def _transform_instructor(self, section_data: dict[str, Any]) -> dict[str, Any]:
        ...
        if instructor_name and instructor_name != "TBA":
            return {
                ...
                "email": instructor_email or f"{instructor_name.lower().replace(' ', '.')}@riohondo.edu"
            }
